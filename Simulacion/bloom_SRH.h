...
protected:
    ...
    MD5_CTX hcontext;               //MD5
    vector<uint64_t> hashseeds;     //Hash seeds 64b
    vector<uint64_t> hashseeds_d{0x7fdf02e238eda0df,0x1baf770ae95a7084,0xbd829c8757a6e061,0xaf51f480c19ad507,0xfe535495b6272354,0xc3bc47ceb44151d3,
                                0xaa21eb0ddcf94954,0x82f08a2826765e4e,0x14a6138c0a028d4d,0x56859db89906a889};  //Static seeds for debug
...
class SR : virtual public BloomFilter{
    MD5_CTX hash_sr;                //Hash for subsets Set and reset
    vector<bool> Storage;           //Memory of bloomfilter 
    void clean();
    void RememberMe(vector<unsigned int> Indexs);
